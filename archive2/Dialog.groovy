	        ...
	        panel(constraints: BorderLayout.SOUTH,maximumSize:[250, 50],background:Color.WHITE ) {
    	    	hbox{
    	        	...
    	        	button text: 'Save', 
    	        		actionPerformed: 
    	        		{ 
    	        			address.classname = cn.text;
				            address.githubuser = githubuser.text 
    	        			address.year = year.text 
        	    			address.author = author.text;
    	        		}
    	        		
        	    	button text: 'Exit', actionPerformed: { address.save(); System.exit(0); }
