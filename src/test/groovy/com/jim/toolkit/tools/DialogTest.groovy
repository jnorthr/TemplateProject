...
class DialogTest extends spock.lang.Specification {
    @Shared
    Dialog test;
	...
	def cleanupSpec() 
	{
		println "end of testing for Dialog"
	}   
 
 
    // First Test
  	def "Build default Dialog"() {
  		when:     'default Dialog has been built'
		then:     test != null;
  	} // end of feature method


    // 2nd Test
    def "Setup Dialog to save a file"() { 
    	setup: 
